...
<head>
    ...
    <title>Etat des Rendez-Vous</title>
    <style>
        body {
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-info bg-gradient shadow-lg py-2">
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent" style="font-size: 20px ;">
                <ul class="navbar-nav ">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="rendez-vous">Rendez-Vous</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row mx-3 my-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div id="test">
                        <form action="/projet/admin/option" method="post">
                            <table id="example" class="table table-striped border border-1 align-content-center text-center" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-content-center text-center">Temps Rendez-Vous</th>
                                ...
                                <tbody>
                                    <?php foreach ($allRendezVous as $rendez) { ?>
                                        <tr>
                                            ...
                                            <td><?php if ($rendez['etat'] == 'requested') {
                                                    echo 'En attente';
                                                } else if($rendez['etat'] == 'accepted') {
                                                    echo 'Accpté';
                                                } else{
                                                    echo 'Traité';
                                                } 
                                            ...
                                            <td>
                                                ...
                                                value="<?= $rendez['id'] ?>" class="btn btn-outline-primary"><i class="bi bi-check2"></i></button>
                                                <button type="button"<?php if ($rendez['etat'] != 'requested') {echo 'disabled';}?> class=" btn btn-outline-danger mx-3" data-bs-toggle="modal" data-bs-target="#delete<?= $rendez['id'] ?>"><i class="bi bi-x-lg"></i></button>

                                            </td>
                                        </tr>
                                        <div class="modal fade" id="delete<?= $rendez['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content ">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-dark" id="staticBackdropLabel">Refus le rendez-vous ?</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>

                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                        <button type="submit" class="btn btn-danger" name="delete" value="<?= $rendez['id'] ?>">Refus</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
