        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent" style="font-size: 20px ;">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="rapport">Rapport</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <table id="example" class="table table-striped align-content-center text-center" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-content-center text-center">Rappot</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($accRapport as $rendez) { ?>
                                        <tr>
                                            <td>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-9">
                                                                    <div class="input-group mb-3">
                                                                        <input type="number" name="Prix" value="<?= $rendez['prix'] ?>" min="1" step="any" readonly class="form-control" aria-label="Amount (to the nearest dollar)">
