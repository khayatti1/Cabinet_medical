        ...
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent" style="font-size: 20px ;">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="paiement">Paiement</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="row mx-3 my-3">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div id="test">
                        <form action="/projet/admin/paiement/reste" method="post">
                            <table id="example" class="table table-striped align-content-center text-center" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-content-center text-center">prix</th>
                                        <th class="align-content-center text-center">reste</th>
                                        <th class="align-content-center text-center">piement</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($paiement as $rendez) { ?>
                                        <tr>
                                            <td>
                                            ...
                                            <td><?= $rendez['cin'] ?></td>
                                            <td><?= $rendez['tel'] ?></td>
                                            <td><?= $rendez['sum(prix)'] ?></td>
                                            <td><?= $rendez['sum(prix)']-$rendez['payedprice']?></td>
                                            <td> <button type="button" class=" btn btn-outline-primary mx-3" data-bs-toggle="modal" data-bs-target="#paiement<?= $rendez['id'] ?>">Entrer</i></button>
                                    </td>
                                        </tr>
                                        <div class="modal fade" id="paiement<?= $rendez['id'] ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content ">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title text-dark" id="staticBackdropLabel">Entrer le montant payé</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="row py-2" style="width:60%; margin-left:20%">
                                                        <div class="form-group form-primary col-12 py-1 ">
                                                            <input type="text" name="paiement<?= $rendez['id'] ?>" class="form-control" autocomplete="off" placeholder="Valider">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="submit" class="btn btn-secondary" name="id" value="<?= $rendez['id'] ?>">Confirmer</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
